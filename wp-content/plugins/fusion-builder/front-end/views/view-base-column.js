	...
	jQuery( document ).ready( function() {
		...
		FusionPageBuilder.BaseColumnView = FusionPageBuilder.BaseView.extend( {
			...
			getStyleVars: function() {
				...
				cssVars.column_gap            = { 'callback': _.fusionGetValueWithUnit };
				cssVars.row_gap               = { 'callback': _.fusionGetValueWithUnit };
				cssVars.column_gap_medium     = { 'callback': _.fusionGetValueWithUnit };
				cssVars.row_gap_medium        = { 'callback': _.fusionGetValueWithUnit };
				cssVars.column_gap_small      = { 'callback': _.fusionGetValueWithUnit };
				cssVars.row_gap_small         = { 'callback': _.fusionGetValueWithUnit };
				
				cssVars.max_height           = { 'callback': _.fusionGetValueWithUnit };
				cssVars.max_height_medium    = { 'callback': _.fusionGetValueWithUnit };
				cssVars.max_height_small     = { 'callback': _.fusionGetValueWithUnit };
